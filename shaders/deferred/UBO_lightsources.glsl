...
{
    DirLight    ubo_dirlights2[MAX_DIRLIGHTS];
    mat4        ubo_dirlight_lightspacematrices2[MAX_DIRLIGHTS];
};

uniform DirLight    ubo_dirlights[MAX_DIRLIGHTS];
uniform mat4        ubo_dirlight_lightspacematrices[MAX_DIRLIGHTS];
