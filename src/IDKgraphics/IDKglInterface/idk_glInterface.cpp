...
void
idk::glInterface::loadTexture(std::string path, GLuint &gl_id, int &w, int &h, uint8_t* &data, bool srgb)
{
    SDL_Surface *img;
...
void
idk::glInterface::genFramebuffer(int width, int height, GLuint &FBO, GLuint &RBO, idk::vector<GLuint> &textures)
{
...
void
idk::glInterface::genFramebuffer(int width, int height, idk::glFramebuffer &fb)
{
    genFramebuffer(width, height, fb.FBO, fb.RBO, fb.textures);
}
...
void
idk::glInterface::bindFramebuffer( int width, int height, idk::glFramebuffer &framebuffer )
{
...
// void
// idk::glInterface::drawModel( idk::Model &model, idk::Transform &transform )
// {
...
// void
// idk::glInterface::drawModel( idk::Model &model, idk::Transform &transform, idk::glUniforms &uniforms )
// {
//     glm::mat4 model_mat = transform.modelMatrix();
//     setmat4("un_model", model_mat);
...
void
idk::glInterface::drawArrays( GLenum mode, GLuint VAO, int num_vertices )
{
    GLCALL( glBindVertexArray(VAO); )
    GLCALL( glDrawArrays(mode, 0, num_vertices); )
    GLCALL( glBindVertexArray(0); )
}


void
idk::glInterface::setint(std::string name, int i)
{
    GLCALL(
...
void
idk::glInterface::setfloat(std::string name, float f)
{
    GLCALL(
        GLuint loc = glGetUniformLocation(_active_shader_id, name.c_str());
        glUniform1f(loc, f);
...
void
idk::glInterface::setvec2(std::string name, glm::vec2 v)
{
    GLCALL(
        GLuint loc = glGetUniformLocation(_active_shader_id, name.c_str());
...
void
idk::glInterface::setvec3(std::string name, glm::vec3 v)
{
    GLCALL(
        GLuint loc = glGetUniformLocation(_active_shader_id, name.c_str());
...
void
idk::glInterface::setvec4(std::string name, glm::vec4 v)
{
    GLCALL(
        GLuint loc = glGetUniformLocation(_active_shader_id, name.c_str());
...
void
idk::glInterface::setmat3(std::string name, glm::mat3 m)
{
    GLCALL(
        GLuint loc = glGetUniformLocation(_active_shader_id, name.c_str());
...
void
idk::glInterface::setmat4(std::string name, glm::mat4 m)
{
    GLCALL(
        GLuint loc = glGetUniformLocation(_active_shader_id, name.c_str());
...
void
idk::glInterface::setvec2(std::string name, const float *v)
{
    GLCALL(
        GLuint loc = glGetUniformLocation(_active_shader_id, name.c_str());
...
void
idk::glInterface::setvec3(std::string name, float *v)
{
    GLCALL(
        GLuint loc = glGetUniformLocation(_active_shader_id, name.c_str());
...
void
idk::glInterface::setvec4(std::string name, float *v)
{
    GLCALL(
        GLuint loc = glGetUniformLocation(_active_shader_id, name.c_str());
...
void
idk::glInterface::setmat3(std::string name, float *m)
{
    GLCALL(
        GLuint loc = glGetUniformLocation(_active_shader_id, name.c_str());
...
void
idk::glInterface::setmat4(std::string name, float *m)
{
    GLCALL(
        GLuint loc = glGetUniformLocation(_active_shader_id, name.c_str());
