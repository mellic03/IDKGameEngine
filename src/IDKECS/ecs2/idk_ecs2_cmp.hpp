...
//     virtual void onObjectAssignment( idk::EngineAPI &api, idk::ECS &ecs, int obj_id )
//     {
//         T::onObjectAssignment(api, obj_id);
//     };

//     virtual void onObjectDeassignment( idk::EngineAPI &api, idk::ECS &ecs, int obj_id )
//     {
//         T::onObjectDeassignment(api, obj_id);
//     };

//     virtual void onObjectCopy( idk::ECS &ecs, int src_obj, int dst_obj )
//     {
